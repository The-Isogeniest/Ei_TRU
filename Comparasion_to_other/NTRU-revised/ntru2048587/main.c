...
#define other_order (541*2)   /*Dihedral group order*/
// #define other_order (6*109)   /* Our work order*/
...
main()
{
    ...
    for (int i=0; i<trials; i++) {
        ...
        execution_time_key += ((double)(end_key - start_key)/ret_val); //key generation
   ...
   // printf("clock per second: %ld \n", CLOCKS_PER_SEC);
    ...
    printf("Average Time taken to execute all : %f (ms) \n", execution_time/trials);
